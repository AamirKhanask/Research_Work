...
class HGRNBitAttention(nn.Module):
    ...
    def forward(
        ...
        lower_bound: Optional[torch.Tensor] = None,  # ← ADD THIS PARAMETER
        **kwargs
        ...
        # ========== ADD THIS BLOCK ==========
        # Apply lower bound to forget gate (prevents complete loss of history)
        # The lower bound for the first layer is 0 (no bound)
